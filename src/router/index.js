...
var routes = [{
    ...
    children: [{
        ...
        },
        {
            ...
            component: r => require.ensure([], () => r(require('@/views/article/index'))),
        },
        {
            ...
            component: r => require.ensure([], () => r(require('@/views/files/index'))),
        },
        {
            path: '/files/document',
            name: 'document',
            ...
            component: r => require.ensure([], () => r(require('@/views/files/document'))),
        },
        {
            path: '/files/images',
            name: 'images',
            ...
            component: r => require.ensure([], () => r(require('@/views/files/images'))),
        },
        {
            path: '/files/media',
            name: 'media',
            ...
            component: r => require.ensure([], () => r(require('@/views/files/media'))),
        },
        {
            path: '/chat2',
            name: 'chat2',
            ...
            component: r => require.ensure([], () => r(require('@/views/chat/chat2'))),
        },
    ...
    path: '/login',
    name: 'login',
    component: r => require.ensure([], () => r(require('@/views/auth/login')))
}, {
    path: '/404',
    name: 'notFound',
